...
Мод находится в активной разработке. Текущая версия уже добавляет новый растительный контент, инструменты, рецепты, локализацию и первые интеграции с другими модами.
